...
class EmailOrUsernameAuthenticationForm(AuthenticationForm):
    """Accept Django username or matching user email (case-insensitive) plus password."""
    ...
    def clean(self):
        ...
        if username is not None and password:
            ...
            if self.user_cache is None:
                ...
                email_key = username.strip()
                for user in UserModel.objects.filter(email__iexact=email_key):
