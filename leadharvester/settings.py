...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-rb4sz3v!nr+3tj251_xd1ssa-ddjqhc3$_1j#sq)od#6bben8s")
...
ROOT_URLCONF = "leadharvester.urls"
...
WSGI_APPLICATION = "leadharvester.wsgi.application"
...
YELLOWPAGES_USER_AGENT = os.getenv(
    "YELLOWPAGES_USER_AGENT",
